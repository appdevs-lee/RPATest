...
final class AccidentResponseViewController: UIViewController {
    ...
    lazy var accidentPhotoTitleLabel: UILabel = {
        let label = UILabel()
        label.text = "촬영한 사진을 앨범에서 가져와주세요."
    ...
    lazy var accidentPhotoGuideLabel: UILabel = {
        let label = UILabel()
        label.text = "(내 차, 상대차, 가깝게 찍은 사진, 멀리서 찍은 사진)"
    ...
    init(contentNumber: Int = 0, parentNumber: Int = 0) {
...
extension AccidentResponseViewController: EssentialViewMethods {
    func setViewFoundation() {
        ...
        self.navigationItem.title = "사고 현장 촬영 및 경위서 작성"
    ...
    func setSubviews() {
        self.view.addSubview(self.accidentPhotoTitleLabel)
        self.view.addSubview(self.accidentPhotoGuideLabel)
    ...
    func setLayouts() {
        ...
        NSLayoutConstraint.activate([
            self.callButton.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -16),
            self.callButton.bottomAnchor.constraint(equalTo: safeArea.bottomAnchor, constant: -16),
        ...
        NSLayoutConstraint.activate([
            self.accidentPhotoTitleLabel.topAnchor.constraint(equalTo: safeArea.topAnchor, constant: 16),
            self.accidentPhotoTitleLabel.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 16),
            self.accidentPhotoTitleLabel.trailingAnchor.constraint(equalTo: safeArea.trailingAnchor, constant: -16)
        ])
        
        // accidentPhotoGuideLabel
        NSLayoutConstraint.activate([
            self.accidentPhotoGuideLabel.leadingAnchor.constraint(equalTo: safeArea.leadingAnchor, constant: 16),
            self.accidentPhotoGuideLabel.topAnchor.constraint(equalTo: self.accidentPhotoTitleLabel.bottomAnchor, constant: 8)
        ])
        
        // plusButton
        NSLayoutConstraint.activate([
            self.plusButton.topAnchor.constraint(equalTo: self.accidentPhotoGuideLabel.bottomAnchor, constant: 16),
...
extension AccidentResponseViewController: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
...
extension AccidentResponseViewController: UITextViewDelegate {
...
extension AccidentResponseViewController: PHPickerViewControllerDelegate {
