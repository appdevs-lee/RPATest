...
final class InspectionTableViewCell: UITableViewCell {
...
extension InspectionTableViewCell {
    func setCell(inspection: InspectionItem) {
        self.titleLabel.text = inspection.content
        self.statusLabel.text = inspection.status
        self.timeLabel.text = inspection.date
    }
}
