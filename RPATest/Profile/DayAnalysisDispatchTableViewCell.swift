//
//  DayAnalysisDispatchTableViewCell.swift
//  RPATest
//
...
final class DayAnalysisDispatchTableViewCell: UITableViewCell {
...
extension DayAnalysisDispatchTableViewCell {
    // Set view foundation
...
extension DayAnalysisDispatchTableViewCell {
    func setCell(item: Any?) {
        if let item = item as? DispatchRegularlyItem {
        ...
        } else if let item = item as? DispatchOrderItem {
            self.departureTimeLabel.text = item.departureDate.sliceString()
            self.departureLabel.text = item.departure
